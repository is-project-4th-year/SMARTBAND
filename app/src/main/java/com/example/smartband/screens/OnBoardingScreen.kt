                ...
                0 -> { // Page 1 with pattern background
                    Box(
                        ...
                        )
                        {
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.blobb), // replace with your image
                ...
                2 -> { // Page 3
                    Box(
                        ...
                        Column(
                            ...
                            Text(
                                text = "Stay connected to your child's well-being with real-time updates from ell-being with real-time updates from",
                                fontSize = 16.sp,
                                color = Color.Gray,
                                fontFamily = bodyFont,
                                letterSpacing = 0.02.em,
                        ...
                        )
                        {
                            Image(
                                ...
                                contentDescription = "Girl meditating",
                                modifier = Modifier.fillMaxSize(),
                                contentScale = ContentScale.Fit
                            )
                            ...
                            Column() {
                                Button(
                                    ...
                                    modifier = Modifier
                                        ...
                                        .border(
                                            width = 1.dp,
                                            color = Color.Black,      // 👈 choose your border color
                                            shape = RectangleShape    // 👈 must match your button shape
                                        )
                                )
                                {
                                    Text(
